...
./do_task_label.py --label_single_step --dagger_states_file ${OUT_PREFIX}_sampled_states.h5 data/misc/actions.h5 ${OUT_PREFIX}_labeled_states.h5
...
./rope_qlearn.py --quad_landmark_features --landmark_features data/misc/landmarks/landmarks_70.h5 --rbf build-constraints-no-model --ignore_bellman_constraints ${OUT_PREFIX}_labeled_states_nodeadend.h5 ${OUT_PREFIX}_constraints.h5 data/misc/actions.h5 bellman
...
./rope_qlearn.py --quad_landmark_features --landmark_features data/misc/landmarks/landmarks_70.h5 --rbf optimize-model ${OUT_PREFIX}_model.mps --C 2 --D 1 --F 1 ${OUT_PREFIX}_weights.h5 data/misc/actions.h5 bellman
